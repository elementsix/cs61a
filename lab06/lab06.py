...
class Person(object):
    ...
    def __init__(self, name):
        self.name = name
        "*** YOUR CODE HERE ***"
        self.last_line = 'I squirreled it away before it could catch on fire.'

    def say(self, stuff):
        "*** YOUR CODE HERE ***"
        self.last_line = stuff
        return stuff

    def ask(self, stuff):
        self.last_line = self.say("Would you please " + stuff)
        return self.last_line

    def greet(self):
        self.last_line = self.say("Hello, my name is " + self.name)
        return self.last_line
